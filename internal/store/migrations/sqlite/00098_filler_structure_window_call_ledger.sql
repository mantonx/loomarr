-- +goose Up
-- V67 (§10): durable per-window reservations and content-addressed settlements.
-- Shared inference rows own spend accounting; this journal binds each call to the complete
-- long-reel media set and exact ordinal. JSON stays TEXT in both dialects for byte inspection.
