...
func TestEvaluateRunsSerialCascadeAndRejectsOnlyTwoModelNegatives(t *testing.T) {
	...
	proposer := &recordfixture.Recorder[proposalRequest, proposalOutput]{Respond: func(proposalRequest) (proposalOutput, error) {
	...
	extractor := &recordfixture.Recorder[Candidate, []byte]{Respond: func(Candidate) ([]byte, error) { return validCandidateWAV(), nil }}
...
func TestEvaluatePresenceOutranksFailureAndSkipsVideo(t *testing.T) {
	...
	extractor := &recordfixture.Recorder[Candidate, []byte]{Respond: func(candidate Candidate) ([]byte, error) {
...
func TestEvaluateNoCandidatesStillRequiresCompleteVideo(t *testing.T) {
	...
	emptyExtractor := &recordfixture.Recorder[Candidate, []byte]{Respond: func(Candidate) ([]byte, error) { return validCandidateWAV(), nil }}
	emptyAudio := &recordfixture.Recorder[Candidate, audioAttempt]{Respond: func(candidate Candidate) (audioAttempt, error) {
